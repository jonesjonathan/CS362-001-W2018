...
public class ApptRandomTest {
    ...
    public static String RandomSelectMethod(Random random){
        String[] methodArray = new String[] {"setTitle","setRecurrence", "setStartDay", "setStartHour", "setStartYear", "setStartMonth", "setStartMinute"};// The list of the of methods to be tested in the Appt class
			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						   ...
						   int sizeArray=ValuesGenerator.getRandomIntBetween(random, -3, 8);
